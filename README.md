...
2. After Plandovania starts, drag-and-drop your `.rdvgame` file into Plandovania or click "Import game file," and follow the on-screen instructions. You can get .rdvgame files [here](https://github.com/realtetrisfreak/Plandos) or at `https://github.com/realtetrisfreak/Plandos`.
